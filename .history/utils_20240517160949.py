...
def get_model_names(model_name, dataset_name, base_model_dir):
    ...
    if 'ClassWeighted_scale_minmax' in base_model_dir:
        ...
        beauty_model_names = ['20240326_1629_2__beauty_lr_0.001_auc_roc_0.93.pt',
                              ...
                              'none_ann_xl']
        compas_model_names = ['/Users/skrishna/Documents/codes/st_project/my_version/LLM_Explainer/models/ClassWeighted/ANN_XL/20240517_1606_256_128_64_32_16_2__compas_ann_xl_0.001_auc_roc_0.83.pt']
        model_file_names_data = {
