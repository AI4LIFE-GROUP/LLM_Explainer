...
# Experiment
from LLM_Explainer.openxai.experiment_utils import ExperimentRunner
...
from LLM_Explainer.openxai.explainers.catalog.perturbation_methods import NewDiscrete_NormalPerturbation
...
from LLM_Explainer.openxai.experiment_config import *
...
def main():
    ...
    for model_name in model_names:
        ...
        for data_name in data_names:
            ...
            if data_name == 'compas':
                feature_types = ['c', 'c', 'c', 'c', 'c', 'c']  #'c', 'd', 'c', 'c', 'd', 'd', 'd']
            # Adult feature types
            elif data_name == 'adult':
                feature_types = ['c'] * 13  #  + ['d'] * 7
